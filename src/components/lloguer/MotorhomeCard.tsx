...
// ✅ Importem el tipus des del nostre fitxer central
...
const MotorhomeCard = ({ motorhome, onShowDetails }: MotorhomeCardProps) => (
    ...
    >
        <div className="relative w-full h-56 md:h-64 lg:h-72">
            <Image className="object-cover" src={motorhome.image_url} alt={motorhome.name} fill sizes="(max-width: 768px) 100vw, 50vw" />
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <p className="text-gray-700 mb-6 text-base flex-grow line-clamp-3 leading-relaxed">{motorhome.description}</p>
            <div className='mt-auto text-left flex items-baseline'>
                <span className="text-lg text-gray-500">des de </span>
                <span className="font-extrabold text-4xl text-red-600 ml-2">{motorhome.pricing?.low_season}€</span>
